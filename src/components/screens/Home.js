  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Container>
        ...
        <GroupA row ss>
          <ImageA little s medium source={{ uri: 'https://firebasestorage.googleapis.com/v0/b/asmmob306-78bf4.appspot.com/o/picture%2Fpsmcg.png?alt=media&token=795fbbdc-2612-4a14-a248-b9b4259fb5b4' }} />
        </GroupA>
        <GroupA col s p>
          <TextC color='#333' medium heavy >Thanh Phụng</TextC>
          <TextC a color='#333' medium light >Basic</TextC>
        </GroupA>
        <GroupA row>
          <TouchableOpacity>
      ...
      <GroupA col s>
        ...
        <TextC large heavy color='#000' p>Continue Watching</TextC>
        <ScrollView showsVerticalScrollIndicator={false} horizontal={true}>
          {
            dataMovie.map((c, i) => {
              return (
                <TouchableOpacityA>
                  ...
                  <ViewA>
                    <TextC large heavy p>Title</TextC>
                  </ViewA>
                  <ViewB>
            ...
            dataMovie.map((c, i) => {
              return (
                <TouchableOpacityB>
                  ...
                  <TextC color='#333' medium heavy>Cast</TextC>
                </TouchableOpacityB>
              )
            })
          }
      ...
      <GroupA row ss>
        <TextC medium heavy color='#000' p>New</TextC>
        <TextC medium heavy color='#000' p>Recommed</TextC>
        <TextC medium heavy color='#000' p>Trending</TextC>
      </GroupA>
        ...
        <ScrollView showsVerticalScrollIndicator={false} horizontal={true}>
          {
            dataMovie.map((c, i) => {
              return (
                <TouchableOpacityA >
                  <ImageA max xxl little source={{ uri: c.albumArtUrl }} />
                  <TextC color='#333' medium bold>{c.title}</TextC>
                </TouchableOpacityA>
      ...
      <GroupA col s b>
        <TextC large heavy color='#000' p>Cartoon</TextC>
              ...
              return (
                <TouchableOpacity>
                  <ContainerA>
                    ...
                    <GroupA row>
                      <TouchableOpacity>
                        <Feather name={'more-horizontal'} size={30} color='#be2edd' />
                      </TouchableOpacity>
                    </GroupA>
                  </ContainerA>
                </TouchableOpacity>
      ...
      <TouchableOpacityC>
        <TextC small light color='#be2edd'>View more</TextC>
      </TouchableOpacityC>


      <GroupA col s t>
        <TextC medium heavy color='#000' p t>Trailer</TextC>
      ...
      <GroupA col s t>
        <TextC medium heavy color='#000' p t>Cast</TextC>
        <ScrollView showsVerticalScrollIndicator={false} horizontal={true}>
          {
            dataMovie.map((c, i) => {
              return (
